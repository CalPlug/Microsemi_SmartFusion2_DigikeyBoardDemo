This folder contains  the most recent Libero project for the demonstration application to be used in conjunction with the ESP8266.  This demonstration application is implemented on the Digikey Maker Board (with the Microsemi SmartFusion 2 FPGA).
...
2) Upload the fabric and eNVM designs to the Maker board from this Libro SoC 11.8 project, make sure ESP8266 ESP01 board is connected and programmed.  Remember the FPGA design used to allow ESP programming will not provide functionality beyond this.
